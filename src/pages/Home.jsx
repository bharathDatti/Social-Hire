...
const Home = () => {
  ...
  useEffect(() => {
    AOS.init({
      ...
      once: true,
      mirror: false,
      offset: 50 // Reduced offset for smaller screens
    });
  }, []);
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12" data-aos="fade-up">
          <div className="flex flex-col md:flex-row bg-white bg-opacity-10 rounded-2xl p-4 sm:p-6 items-center">
            ...
            <div className="w-full md:w-1/2 flex justify-center" data-aos="fade-left">
              <img src="/carrergrowth.png" className="w-full max-w-xs sm:max-w-sm md:max-w-md m-3" alt="Career Growth" />
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="min-h-screen text-white bg-black bg-[url('./bg2.png')] bg-no-repeat bg-cover bg-center">
        <div className="container mx-auto px-4 py-8 sm:py-12" data-aos="fade-up">
          <div className="flex flex-col md:flex-row bg-white bg-opacity-10 rounded-2xl p-4 sm:p-6 items-center">
            <div className="w-full md:w-2/5 mb-6 md:mb-0" data-aos="fade-right">
              <img src="/jobsearch.png" alt="Job Search" className="rounded-lg w-full h-auto" />
            </div>
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12" data-aos="fade-up">
          <div className="flex flex-col md:flex-row bg-white bg-opacity-10 rounded-2xl p-4 sm:p-6 items-center gap-4">
            ...
            <div className="w-full md:w-2/5 flex justify-center" data-aos="fade-left">
              <img src="/mentorship.png" alt="Mentorship" className="w-full max-w-xs sm:max-w-sm md:max-w-md rounded-lg shadow-lg" />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12" data-aos="fade-up">
          <div className="flex flex-col md:flex-row bg-white bg-opacity-10 rounded-2xl p-4 sm:p-6 items-center">
            <div className="w-full md:w-2/5 mb-6 md:mb-0" data-aos="fade-right">
              <img src="/airesume.png" alt="Resume Builder" className="rounded-lg w-full h-auto" />
            </div>
            <div className="w-full md:w-1/2 text-center md:text-end">
              <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold">
                Create a Winning{" "}
              ...
              <p className="text-gray-400 mt-3 text-xs sm:text-sm md:text-base">
                Make your resume stand out effortlessly with SocialHire's AI-powered tools.
                Build, optimize, and ensure your resume passes Applicant Tracking Systems (ATS).
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 py-8 sm:py-12" data-aos="fade-up">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-white bg-opacity-10 rounded-2xl p-4 sm:p-7">
            ...
            <div data-aos="fade-left">
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl mt-8 md:mt-36 font-bold text-center text-white">
                Want a feature on{" "}
                <span className="bg-gradient-to-r from-cyan-400 to-blue-500 text-transparent bg-clip-text">
                  SocialHire?
                </span>
              </h2>
              <p className="text-gray-400 mt-2 px-2 sm:px-8 text-center text-xs sm:text-sm md:text-base">
                If there are features you would like us to have on SocialHire to aid
                your recruitment and matching process, kindly.
              </p>
              <p className="text-lg sm:text-xl md:text-2xl text-center mt-4">Drop an E-mail: socialhire@gmail.com</p>
            </div>
          </div>
        </div>
      </section>
